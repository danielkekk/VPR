...
class CreateOgykepviseloPosztTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ogykepviselo_poszt', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('ogykepviselo_id');
            $table->string('ev',10);
    ...
    {
        Schema::dropIfExists('ogykepviselo_poszt');
    }
}
