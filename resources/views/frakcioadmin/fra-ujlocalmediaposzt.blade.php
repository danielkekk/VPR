    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <form id="ujlocalmedia-form" action="{{ url('/fra-createlocalmediaposzt') }}" method="POST">
                    @csrf

                    <label for="localmedia">Országos média</label>
                    <select name="localmedia">
                        <?php
                        if(!empty($localmediak)) {
                            foreach($localmediak as $localmedia) { ?>
                                <option value="<?php echo $localmedia->id; ?>"><?php echo $localmedia->name; ?></option>
                        <?php }
                        }?>
                    </select><br>
