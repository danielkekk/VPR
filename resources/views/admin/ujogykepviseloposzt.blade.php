    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <form id="ujogykepviselo-form" action="{{ url('/createogykepviseloposzt') }}" method="POST">
                    @csrf

                    <label for="ogykepviselo">Ogy. képviselő</label>
                    <select name="ogykepviselo">
                        <?php
                        if(!empty($ogykepviselok)) {
                            foreach($ogykepviselok as $ogykepviselo) { ?>
                                <option value="<?php echo $ogykepviselo->id; ?>"><?php echo $ogykepviselo->name; ?></option>
                        <?php }
                        }?>
                    </select><br>
