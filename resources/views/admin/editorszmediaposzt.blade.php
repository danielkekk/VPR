            ...
            <div class="content">
                ...
                <br><br><br>
                    ...
                    foreach($napiposztok as $napiposzt) {
                        echo '<span style="color: red; font-weight: bold;">' . $napiposzt['tipus'] . '&nbsp;('.$napiposzt['reakcio'].')</span>&nbsp;&nbsp;&nbsp;<a href="'.url("/deleteorszmediaposztbyid/{$orszmediaposztid}/{$napiposzt['id']}").'">[X]</a><br>';
                    }
                    ?>

                    <br><br><br>
                <form id="ujorszmediaposztedit-form" action="{{ url('/editorszmediaposztsave') }}" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="azon" id="azon" value="<?php echo $orszmediaposztid;?>"/>
