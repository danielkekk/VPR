    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <form id="ujkepviselo-form" action="{{ url('/createkepviselo') }}" method="POST">
                    @csrf
                    ...
                    <label for="kepviselofrakcio">Frakció</label>
                    <select name="kepviselofrakcio">
                        <?php foreach($frakciok as $frakcio) { ?>
                        <option value="<?php echo $frakcio->id;?>"><?php echo $frakcio->name;?></option>
                            <?php } ?>
                    </select><br>
                    ...
                    <select name="kepviselorole">
                        ...
                        <option value="2">Frakcióadmin</option>
