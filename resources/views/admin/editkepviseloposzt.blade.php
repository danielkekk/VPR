            ...
            <div class="content">
                ...
                <br><br><br>
                    ...
                    foreach($napiposztok as $napiposzt) {
                        echo '<span style="color: red; font-weight: bold;">' . $napiposzt['tipus'] . '&nbsp;('.$napiposzt['reakcio'].')</span>&nbsp;&nbsp;&nbsp;<a href="'.url("/deletekepviseloposztbyid/{$kepviseloposztid}/{$napiposzt['id']}").'">[X]</a><br>';
                    }
                    ?>

                    <br><br><br>
                <form id="ujfkepviseloposztedit-form" action="{{ url('/editkepviseloposztsave') }}" method="POST">
                    <?php echo csrf_field(); ?>
